...
- **A frontend application layer** with live aircraft rendering, trails, routes, sensor locations, search, details, file import, and historical trajectories.
